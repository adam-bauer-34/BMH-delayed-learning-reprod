...
class INVRecourseModelExp():
    """Abatement investment model class with an expectation objective function.
    ...
    method: int
        integration method for expectation operator
    ...
    def _save_output(self):
        ...
        cwd = os.getcwd()
        path = ''.join([cwd, '/data/output/', self.cal, '_N', str(self.N_samples), '_method', str(self.method), '_invrecexp_output.nc'])
