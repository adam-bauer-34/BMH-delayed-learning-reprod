...
To run: python invRecEmis_cvxpy_main.py [cal] [rec_cal] [method] [solve_model] [save_output]
"""

import sys

from src.invRecExpEmis_model import INVRecourseModelExpEmis
...
m = INVRecourseModelExpEmis(cal, N_samples, method)
...
if solve_model:
    ...
    print("The total cost is: ", m.prob.value)